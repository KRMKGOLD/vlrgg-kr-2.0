...
| MyPage, 즐겨찾기, Match 알림, About | Stage 1 H2/loop/Firebase 기반 코드 존재. Firestore Emulator·익명 Target 권한·START-only·request-bound scheduler로 교체하는 Stage 1.1은 설계 완료/구현 전 | Feature 미구현 — App·실제 Firebase 연동은 Stage 2 |
